...
BOOST_AUTO_TEST_CASE(message_sign)
{
    const std::array<unsigned char, 32> privkey_bytes = {
        ...
        // derived address from this private key: AKyJbkVbkxvi9UMvgwSd5Nu1CbZ2S7p9Rm
...
BOOST_AUTO_TEST_CASE(message_verify)
{
    ...
    BOOST_CHECK_EQUAL(
        MessageVerify(
            "5BmgLQixnUoX1GAUmqDCZ9wFfh3gzSx37u",
            "signature should be irrelevant",
            "message too"),
    ...
    BOOST_CHECK_EQUAL(
        MessageVerify(
            "AacTqKCbQPpaaRbCd9E7N75eDMQdBsTXtM",
    ...
    BOOST_CHECK_EQUAL(
        MessageVerify(
            "AKyJbkVbkxvi9UMvgwSd5Nu1CbZ2S7p9Rm",
            "IPojfrX2dfPnH26UegfbGQQLrdK844DlHq5157/P6h57WyuS/Qsl+h/WSVGDF4MUi4rWSswW38oimDYfNNUBUOk=",
            "I never signed this"),
    ...
    BOOST_CHECK_EQUAL(
        MessageVerify(
            "AFnVEHmL9JBBBmpvmUnHXjfdwNQNtZmfhR",
