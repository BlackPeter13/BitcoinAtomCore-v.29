...
void UpdateCoins(const CTransaction& tx, CCoinsViewCache& inputs, CTxUndo &txundo, int nHeight, uint32_t nTime = 0);
...
{
    // Good example (Atom: block-time varint follows the code varint)
    DataStream ss1{"97f23c00835800816115944e077fe7c803cfa57f29b36bf87c1d35"_hex};
    Coin cc1;
    ss1 >> cc1;
    ...
    // Good example
    DataStream ss2{"8ddf7700bbd123008c988f1a4a4de2161e0f50aac7f17e7f9555caa4"_hex};
    Coin cc2;
    ss2 >> cc2;
