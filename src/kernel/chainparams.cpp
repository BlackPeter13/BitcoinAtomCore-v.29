...
public:
    CMainParams() {
        ...
        // Atom: hard-fork activation and post-fork consensus
        ...
        consensus.powLimitStart = uint256{"000001ffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"};
        ...
        // Atom: proof-of-stake parameters
        ...
        consensus.nInitialHashTargetPoS = uint256{"00000000ffffffffffffffffffffffffffffffffffffffffffffffffffffffff"};
        ...
        consensus.nMinimumChainWork = uint256{"000000000000000000000000000000000000000000f7a10d870760a5efb2aef8"};
        consensus.defaultAssumeValid = uint256{"00000000000000133f94ee631c4b2f6d4eabc42865ad6f67d2ae63e24921ff21"}; // Atom chain, height 594478
        // Atom: bootstrap reference to the Bitcoin chain the fork started from
        consensus.BitcoinPostforkBlock = uint256{"00000000000000000059669eda134efcdd6ba0c8d1475a4c0436f4f6a3ed41f2"};
        ...
        nBitcoinDefaultPort = 8333; // Default bitcoin port (bootstrap peers)
        ...
        // Atom: bootstrap (Bitcoin) seeds for pre-fork history, Atom seeds after.
        ...
        vBootstrapSeeds.emplace_back("seed.btc.petertodd.net."); // Peter Todd, only supports x1, x5, x9, and xd
        vBootstrapSeeds.emplace_back("seed.bitcoin.sprovoost.nl."); // Sjors Provoost
        vBootstrapSeeds.emplace_back("dnsseed.emzy.de."); // Stephan Oeste
        vBootstrapSeeds.emplace_back("seed.bitcoin.wiz.biz."); // Jason Maurice
        vBootstrapSeeds.emplace_back("seed.mainnet.achownodes.xyz."); // Ava Chow
        ...
        // Atom: no fixed seeds in this port. The stock Bitcoin fixed seeds do
        // not belong to the Atom network, and the legacy BCA fixed-seed
        // arrays have not been converted to the serialized seed format yet.
        // DNS seeds above cover first-boot discovery.
        vFixedSeeds.clear();
        ...
        // Atom: the stock assumeutxo snapshots reference post-fork Bitcoin
        // blocks, which are not on the Atom chain. Cleared until Atom
        // snapshots are produced.
        m_assumeutxo_data = {};

        chainTxData = ChainTxData{
            // Atom data as of block 000000000000000cf2b493f174e95e8e320c0046b1004497539718f4073be09c (height 594484).
            .nTime    = 1522652429,
            .tx_count = 295173611,
            .dTxRate  = 1.01,
        };
...
public:
    CTestNetParams() {
        ...
        // Atom: hard-fork activation and post-fork consensus (testnet)
        ...
        consensus.powLimit = uint256{"00000000ffffffffffffffffffffffffffffffffffffffffffffffffffffffff"};
        consensus.powLimitStart = uint256{"000007ffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"};
        consensus.nPowAveragingWindow = 11;
        consensus.nPowTargetTimespan = 14 * 24 * 60 * 60; // two weeks
        consensus.nPowTargetSpacing = 10 * 60;
        ...
        consensus.nMinerConfirmationWindow = 2016; // nPowTargetTimespan / nPowTargetSpacing
        // Atom: proof-of-stake parameters (testnet: fast stake age for testing)
        consensus.nPosTargetTimespan = 14 * 24 * 60 * 60; // two weeks
        consensus.nPosTargetSpacing = 10 * 60;
        ...
        consensus.nInitialHashTargetPoS = uint256{"000007ffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"};
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].bit = 28;
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].nStartTime = Consensus::BIP9Deployment::NEVER_ACTIVE;
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].nTimeout = Consensus::BIP9Deployment::NO_TIMEOUT;
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].min_activation_height = 0; // No activation delay
        ...
        consensus.defaultAssumeValid = uint256{"000000e5f7d38a1d42b82fabaf6630ff5b2c6f96a5d7ca4863a1f2f8131d1606"}; // Atom testnet, height 1300018
        // Atom: bootstrap reference to the Bitcoin testnet chain
        consensus.BitcoinPostforkBlock = uint256{"00000000000007b38d7b63e5f83323f7fba85f66a45f16c7c8e4a5d39420da58"};
        ...
        nBitcoinDefaultPort = 18333; // Default bitcoin port (bootstrap peers)
        ...
        // Atom: bootstrap (Bitcoin testnet) seeds for pre-fork history.
        vBootstrapSeeds.emplace_back("testnet-seed.bitcoin.jonasschnelli.ch.");
        vBootstrapSeeds.emplace_back("seed.tbtc.petertodd.net.");
        ...
        // Atom: stock testnet fixed seeds point at Bitcoin nodes, not the
        // Atom network; cleared (DNS seeds above cover discovery).
        vFixedSeeds.clear();
        ...
        // Atom: the stock assumeutxo snapshot references a post-fork Bitcoin
        // testnet block, not on the Atom chain. Cleared.
        m_assumeutxo_data = {};

        chainTxData = ChainTxData{
            // Atom data as of block 0000000005ec7946c982ea8fc424165d9404cf8891748dc4d7eab06db625a683 (height 1320021)
            .nTime    = 1522652070,
            .tx_count = 17114123,
            .dTxRate  = 0.08,
        };
...
public:
    explicit CRegTestParams(const RegTestOptions& opts)
    {
        ...
        consensus.MinBIP9WarningHeight = 0;
        // Atom: fork activation on regtest (low heights for functional tests)
        consensus.BCAHeight = 1500;
        consensus.BCAInitLim = 100;
        consensus.NewDifficultyAdjustmentAlgoHeight = 2000;
        consensus.powLimit = uint256{"7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"};
        consensus.powLimitStart = uint256{"7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"};
        consensus.nPowAveragingWindow = 11;
        ...
        // Atom: proof-of-stake parameters (regtest: fast stake age for tests)
        consensus.nPosTargetTimespan = 14 * 24 * 60 * 60; // two weeks
        consensus.nPosTargetSpacing = 10 * 60;
        ...
        consensus.nInitialHashTargetPoS = uint256{"7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"};
        // Atom: no bootstrap chain on regtest
...
/** Atom: chain parameters with Bitcoin address format, for conversion of
 * pre-fork (legacy) addresses. */
