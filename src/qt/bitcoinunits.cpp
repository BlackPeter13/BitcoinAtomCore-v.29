...
{
    switch (unit) {
    case Unit::BTC: return QString("BCA");
    case Unit::mBTC: return QString("mBCA");
    case Unit::uBTC: return QString::fromUtf8("µBCA (bits)");
...
{
    switch (unit) {
    case Unit::BTC: return QString("Bitcoin Atom");
