...
UniValue blockheaderToJSON(const CBlockIndex& tip, const CBlockIndex& blockindex, const uint256 pow_limit)
{
    ...
    // Atom: consensus flags carried by the block.
...
UniValue blockToJSON(BlockManager& blockman, const CBlock& block, const CBlockIndex& tip, const CBlockIndex& blockindex, TxVerbosity verbosity, const uint256 pow_limit)
{
    ...
    // Atom: proof-of-stake linkage (only meaningful for PoS blocks).
    ...
    return RPCHelpMan{"getblockchaininfo",
        ...
        RPCResult{
            RPCResult::Type::OBJ, "", "",
            {
                ...
                {RPCResult::Type::NUM, "difficulty_pos", "the current proof-of-stake difficulty (Atom only)"},
                {RPCResult::Type::NUM_TIME, "time", "The block time expressed in " + UNIX_EPOCH_TIME},
                {RPCResult::Type::NUM_TIME, "mediantime", "The median block time expressed in " + UNIX_EPOCH_TIME},
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    // Atom: proof-of-stake difficulty from the most recent PoS block.
    if (const CBlockIndex* pindexPos = GetLastBlockIndex(&tip, chainman.GetConsensus(), /*fProofOfStake=*/true)) {
        obj.pushKV("difficulty_pos", GetDifficulty(*pindexPos));
    }
