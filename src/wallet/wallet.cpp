...
bool CWallet::SignTransaction(CMutableTransaction& tx) const
{
    ...
    std::map<int, bilingual_str> input_errors;
        // Atom: all wallet signatures commit to the Atom fork id (required by
        // post-fork STRICTENC rules, valid pre-fork as well).
...
bool CWallet::Lock()
{
...

    {
        ...
        // Atom: a full lock clears the mint-only restriction.
