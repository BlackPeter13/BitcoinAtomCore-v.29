            ...
            "time that overrides the old one.\n",
                {
                    ...
                    // Atom: mint-only unlock keeps the wallet locked for
                    // spending while allowing proof-of-stake minting.
                    {"mintonly", RPCArg::Type::BOOL, RPCArg::Default{false}, "If true, the wallet is unlocked for staking only"},
                },
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    LOCK(pwallet->m_unlock_mutex);
    {
        ...
        // Atom: mint-only unlock (staking allowed, spending stays locked).
        pwallet->fWalletUnlockMintOnly = request.params[2].isNull() ? false : request.params[2].get_bool();
    }
