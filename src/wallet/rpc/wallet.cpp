    ...
    return RPCHelpMan{"getwalletinfo",
                ...
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
                        ...
                        {RPCResult::Type::BOOL, "mintonly", /*optional=*/true, "whether the wallet is unlocked for staking only (Atom only, only present for passphrase-encrypted wallets)"},
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    if (pwallet->IsCrypted()) {
        ...
        obj.pushKV("mintonly", WITH_LOCK(pwallet->cs_wallet, return pwallet->fWalletUnlockMintOnly));
    }
...
// Atom: atomic-swap (HTLC) RPCs (wallet/rpc/swap.cpp)
...
// Atom: staking-output introspection (wallet/rpc/minting.cpp)
...
Span<const CRPCCommand> GetWalletRPCCommands()
{
    static const CRPCCommand commands[]{
        ...
        {"wallet", &signmessage},
        {"wallet", &initiateswap},
        {"wallet", &participateswap},
        {"wallet", &auditswap},
        {"wallet", &redeemswap},
        {"wallet", &extractsecret},
        {"wallet", &refundswap},
        {"wallet", &listminting},
        {"wallet", &startstaking},
        {"wallet", &stopstaking},
